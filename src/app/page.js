  ...
  return (
    <main className={styles.main}>
      ...
      <section className="notranslate" style={{display:'grid',gridTemplateColumns:`repeat(auto-fit,319px)`,width:`100%`,gridGap:`20px`,justifyContent:`center`,justifyItems:`center`}}>
        {[results.map(c => <Link href={`/${c.i}`} style={{display:`flex`,flexDirection:`column`,width:'319px',border:'1px solid rgb(226, 223, 218)',boxShadow:'rgba(125, 125, 125, 0.2) 0px 0px 5px',borderRadius:`10px`,margin:`10px`,alignItems:`center`,minHeight:`321px`}}>
